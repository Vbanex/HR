...
namespace HRBusiness {
    ...
    public partial class hrDataset : global::System.Data.DataSet {
        ...
        public partial class employeesDataTable : global::System.Data.TypedTableBase<employeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public employeesRow AddemployeesRow(string firstname, string lastname, decimal salary, departmentRow parentdepartmentRowByFK_employees_department, string designation) {
                ...
                if ((parentdepartmentRowByFK_employees_department != null)) {
                    columnValuesArray[4] = parentdepartmentRowByFK_employees_department[0];
                }
...
namespace HRBusiness.hrDatasetTableAdapters {
    ...
    public partial class departmentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Data Source=VBANEX;Initial Catalog=hr;Integrated Security=True";
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "INSERT INTO [dbo].[department] ([name]) VALUES (@name);\r\nSELECT id, name FROM dep" +
                "artment WHERE (id = SCOPE_IDENTITY())";
        ...
        public virtual int InsertNewDepartment(string name) {
    ...
    public partial class employeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[employees] WHERE (([id] = @Original_id) AND ((@IsNull_firstname = 1 AND [firstname] IS NULL) OR ([firstname] = @Original_firstname)) AND ((@IsNull_lastname = 1 AND [lastname] IS NULL) OR ([lastname] = @Original_lastname)) AND ((@IsNull_salary = 1 AND [salary] IS NULL) OR ([salary] = @Original_salary)) AND ((@IsNull_departmentId = 1 AND [departmentId] IS NULL) OR ([departmentId] = @Original_departmentId)) AND ((@IsNull_designation = 1 AND [designation] IS NULL) OR ([designation] = @Original_designation)))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_id", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "id", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[employees] ([firstname], [lastname], [salary], [departmentId], [designation]) VALUES (@firstname, @lastname, @salary, @departmentId, @designation);
SELECT id, firstname, lastname, salary, departmentId, designation FROM employees WHERE (id = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[employees] SET [firstname] = @firstname, [lastname] = @lastname, [salary] = @salary, [departmentId] = @departmentId, [designation] = @designation WHERE (([id] = @Original_id) AND ((@IsNull_firstname = 1 AND [firstname] IS NULL) OR ([firstname] = @Original_firstname)) AND ((@IsNull_lastname = 1 AND [lastname] IS NULL) OR ([lastname] = @Original_lastname)) AND ((@IsNull_salary = 1 AND [salary] IS NULL) OR ([salary] = @Original_salary)) AND ((@IsNull_departmentId = 1 AND [departmentId] IS NULL) OR ([departmentId] = @Original_departmentId)) AND ((@IsNull_designation = 1 AND [designation] IS NULL) OR ([designation] = @Original_designation)));
SELECT id, firstname, lastname, salary, departmentId, designation FROM employees WHERE (id = @id)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT id, firstname, lastname, salary, departmentId, designation FROM dbo.employ" +
                "ees";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = @"INSERT INTO [dbo].[employees] ([firstname], [lastname], [salary], [departmentId], [designation]) VALUES (@firstname, @lastname, @salary, @departmentId, @designation);
SELECT id, firstname, lastname, salary, departmentId, designation FROM employees WHERE (id = SCOPE_IDENTITY())";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            ...
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@salary", global::System.Data.SqlDbType.Decimal, 9, global::System.Data.ParameterDirection.Input, 18, 2, "salary", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@designation", global::System.Data.SqlDbType.NVarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "designation", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = @"SELECT        employees.id, employees.firstname, employees.lastname, employees.salary, employees.departmentId, employees.designation
...
WHERE        (department.id = @id)";
        ...
        public virtual hrDataset.employeesDataTable GetEmployeesByDepartmentId(int id) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_id, string Original_firstname, string Original_lastname, global::System.Nullable<decimal> Original_salary, global::System.Nullable<int> Original_departmentId, string Original_designation) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_id));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(string firstname, string lastname, global::System.Nullable<decimal> salary, global::System.Nullable<int> departmentId, string designation) {
            if ((firstname == null)) {
                this.Adapter.InsertCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string firstname, string lastname, global::System.Nullable<decimal> salary, global::System.Nullable<int> departmentId, string designation, int Original_id, string Original_firstname, string Original_lastname, global::System.Nullable<decimal> Original_salary, global::System.Nullable<int> Original_departmentId, string Original_designation, int id) {
            if ((firstname == null)) {
                this.Adapter.UpdateCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
            else {
        ...
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string firstname, string lastname, global::System.Nullable<decimal> salary, global::System.Nullable<int> departmentId, string designation, int Original_id, string Original_firstname, string Original_lastname, global::System.Nullable<decimal> Original_salary, global::System.Nullable<int> Original_departmentId, string Original_designation) {
            return this.Update(firstname, lastname, salary, departmentId, designation, Original_id, Original_firstname, Original_lastname, Original_salary, Original_departmentId, Original_designation, Original_id);
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, false)]
        public virtual int CreateEmployee(string firstname, string lastname, global::System.Nullable<decimal> salary, global::System.Nullable<int> departmentId, string designation) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[1];
            if ((firstname == null)) {
                command.Parameters[0].Value = global::System.DBNull.Value;
            }
